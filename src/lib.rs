...
pub use normal_field::{
    Cell, DefinedField, FieldError, MineSweeperField, Mines, RandomField, get_evil_ng_field,
...
pub fn minesweeper_ng_field(width: u32, height: u32, mines: Mines) -> Result<impl MineSweeperField, FieldError> {
